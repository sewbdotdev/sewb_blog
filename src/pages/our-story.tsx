...
const OurStoryPage: NextPage = (props) => {
    ...
    return (
        <Content classNames="text-justify">
            <NextSeo {...seo} />
            <h2
                className="text-3xl font-bold mt-5 border-b-2 border-slate-800 pb-2 w-full md:w-1/2 px-10 md:mx-40"
            ...
            <DataWrapper status={status}>
                {data?.ourStory?.data?.attributes?.content && (
                    <section
                        className="px-10 md:mx-40 my-20"
                        data-cy={`${DataCyPrefix}StoryContainer`}
                    >
