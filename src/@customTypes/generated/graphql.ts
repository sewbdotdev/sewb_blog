...
export type GetAllCategoriesQuery = {
    ...
    categories?: {
        ...
        data: Array<{
            __typename?: 'CategoryEntity';
            id?: string | null;
            attributes?: { __typename?: 'Category'; title: string; slug?: string | null } | null;
        }>;
        meta: {
            __typename?: 'ResponseCollectionMeta';
            pagination: {
...
export type GetAllTagsQuery = {
    ...
    tags?: {
        ...
        data: Array<{
            __typename?: 'TagEntity';
            id?: string | null;
            attributes?: { __typename?: 'Tag'; title: string; slug?: string | null } | null;
        }>;
        meta: {
            __typename?: 'ResponseCollectionMeta';
            pagination: {
...
export type GetOneCommentQuery = {
    __typename?: 'Query';
    comment?: {
        __typename?: 'CommentEntityResponse';
        data?: {
...
export type GetStoryQuery = {
    ...
    ourStory?: {
        ...
        data?: {
            __typename?: 'OurStoryEntity';
            id?: string | null;
            attributes?: { __typename?: 'OurStory'; content?: string | null } | null;
        } | null;
    } | null;
};
...
export type GetMinimalPostsByCategoryQuery = {
    __typename?: 'Query';
    posts?: {
        __typename?: 'PostEntityResponseCollection';
        data: Array<{
...
export type PostCommentCountQuery = {
    __typename?: 'Query';
    comments?: {
        __typename?: 'CommentEntityResponseCollection';
        meta: {
...
export type ClapMutation = {
    __typename?: 'Mutation';
    createPostClap?: {
        __typename?: 'PostClapEntityResponse';
        data?: { __typename?: 'PostClapEntity'; id?: string | null } | null;
    } | null;
};
...
export type CategoriesForSitemapQuery = {
    __typename?: 'Query';
    categories?: {
        __typename?: 'CategoryEntityResponseCollection';
        data: Array<{
...
export type TagsForSitemapQuery = {
    __typename?: 'Query';
    tags?: {
        __typename?: 'TagEntityResponseCollection';
        data: Array<{
...
export type PostsForSitemapQuery = {
    __typename?: 'Query';
    posts?: {
        __typename?: 'PostEntityResponseCollection';
        data: Array<{
...
export const GetOneCategoryDocument = `
  ...
  category(id: $id) {
    ...
    `;
export const useGetOneCategoryQuery = <TData = GetOneCategoryQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetOneCategoryQuery, TError, TData>(
        ...
        fetcher<GetOneCategoryQuery, GetOneCategoryQueryVariables>(
            client,
...
export const GetOneTagDocument = `
  ...
  tag(id: $id) {
    ...
    `;
export const useGetOneTagQuery = <TData = GetOneTagQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetOneTagQuery, TError, TData>(
        ['getOneTag', variables],
        fetcher<GetOneTagQuery, GetOneTagQueryVariables>(
            client,
            GetOneTagDocument,
            variables,
            headers
...
export const GetOneCommentDocument = `
  ...
  comment(id: $id) {
    ...
    `;
export const useGetOneCommentQuery = <TData = GetOneCommentQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetOneCommentQuery, TError, TData>(
        ...
        fetcher<GetOneCommentQuery, GetOneCommentQueryVariables>(
            client,
...
export const GetCommentsByPostIdDocument = `
  ...
  comments(
    ...
    `;
export const useGetCommentsByPostIdQuery = <TData = GetCommentsByPostIdQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetCommentsByPostIdQuery, TError, TData>(
        ...
        fetcher<GetCommentsByPostIdQuery, GetCommentsByPostIdQueryVariables>(
            client,
...
export const GetFaqDocument = `
  ...
  faq {
    ...
    `;
export const useGetFaqQuery = <TData = GetFaqQuery, TError = unknown>(
    client: GraphQLClient,
...
export const GetStoryDocument = `
  ...
  ourStory {
    ...
    `;
export const useGetStoryQuery = <TData = GetStoryQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetStoryQuery, TError, TData>(
        ...
        fetcher<GetStoryQuery, GetStoryQueryVariables>(
            client,
            GetStoryDocument,
            variables,
            headers
...
export const GetPostBySlugDocument = `
  ...
  posts(filters: {slug: {eq: $slug}}) {
    ...
    `;
export const useGetPostBySlugQuery = <TData = GetPostBySlugQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetPostBySlugQuery, TError, TData>(
        ...
        fetcher<GetPostBySlugQuery, GetPostBySlugQueryVariables>(
            client,
...
export const GetPostsByCategoryDocument = `
  ...
  posts(
    ...
    `;
export const useGetPostsByCategoryQuery = <TData = GetPostsByCategoryQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetPostsByCategoryQuery, TError, TData>(
        ...
        fetcher<GetPostsByCategoryQuery, GetPostsByCategoryQueryVariables>(
            client,
...
>(
    ...
    useQuery<GetMinimalPostsByCategoryQuery, TError, TData>(
        ...
        fetcher<GetMinimalPostsByCategoryQuery, GetMinimalPostsByCategoryQueryVariables>(
            client,
            GetMinimalPostsByCategoryDocument,
            variables,
            headers
        ),
        options
...
export const PostCommentCountDocument = `
  ...
  comments(filters: {post: {slug: {eq: $postSlug}}}) {
    ...
    `;
export const usePostCommentCountQuery = <TData = PostCommentCountQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<PostCommentCountQuery, TError, TData>(
        ...
        fetcher<PostCommentCountQuery, PostCommentCountQueryVariables>(
            client,
            PostCommentCountDocument,
            variables,
            headers
        ),
        options
...
export const GetPostsByTagDocument = `
  ...
  posts(
    ...
    `;
export const useGetPostsByTagQuery = <TData = GetPostsByTagQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetPostsByTagQuery, TError, TData>(
        ...
        fetcher<GetPostsByTagQuery, GetPostsByTagQueryVariables>(
            client,
...
export const ClapDocument = `
  ...
  createPostClap(data: {post: $postId, users_permissions_user: $userId}) {
    ...
    `;
export const useClapMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<ClapMutation, TError, ClapMutationVariables, TContext>(
        ['clap'],
        (variables?: ClapMutationVariables) =>
            fetcher<ClapMutation, ClapMutationVariables>(
                client,
                ClapDocument,
                variables,
                headers
...
export const UnclapDocument = `
  ...
  deletePostClap(id: $clapId) {
    ...
    `;
export const useUnclapMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    ...
    useMutation<UnclapMutation, TError, UnclapMutationVariables, TContext>(
        ['unclap'],
        (variables?: UnclapMutationVariables) =>
            fetcher<UnclapMutation, UnclapMutationVariables>(
                client,
                UnclapDocument,
                variables,
                headers
...
export const GetPostClapsDocument = `
  ...
  postClaps(filters: {post: {id: {eq: $postId}}}) {
    ...
    `;
export const useGetPostClapsQuery = <TData = GetPostClapsQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<GetPostClapsQuery, TError, TData>(
        ...
        fetcher<GetPostClapsQuery, GetPostClapsQueryVariables>(
            client,
            GetPostClapsDocument,
            variables,
            headers
        ),
        options
...
export const useUpdateMeMutation = <TError = unknown, TContext = unknown>(
    ...
    useMutation<UpdateMeMutation, TError, UpdateMeMutationVariables, TContext>(
        ...
        (variables?: UpdateMeMutationVariables) =>
            fetcher<UpdateMeMutation, UpdateMeMutationVariables>(
                client,
                UpdateMeDocument,
                variables,
                headers
...
export const CategoriesForSitemapDocument = `
  ...
  categories(pagination: {page: $page, pageSize: $pageSize}) {
    ...
    `;
export const useCategoriesForSitemapQuery = <TData = CategoriesForSitemapQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<CategoriesForSitemapQuery, TError, TData>(
        ...
        fetcher<CategoriesForSitemapQuery, CategoriesForSitemapQueryVariables>(
            client,
...
export const TagsForSitemapDocument = `
  ...
  tags(pagination: {page: $page, pageSize: $pageSize}) {
    ...
    `;
export const useTagsForSitemapQuery = <TData = TagsForSitemapQuery, TError = unknown>(
    client: GraphQLClient,
    ...
    useQuery<TagsForSitemapQuery, TError, TData>(
        ...
        fetcher<TagsForSitemapQuery, TagsForSitemapQueryVariables>(
            client,
...
export const PostsForSitemapDocument = `
  ...
  posts(pagination: {page: $page, pageSize: $pageSize}) {
    ...
    `;
export const usePostsForSitemapQuery = <TData = PostsForSitemapQuery, TError = unknown>(
    client: GraphQLClient,
